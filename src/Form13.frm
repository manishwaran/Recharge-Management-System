...
rsEmp.Open "select * from netp where ID = '" & Text1.Text & "'", connEmp, adOpenKeyset, adLockReadOnly, adCmdText
...
Else
Set rsEmp = New ADODB.Recordset
rsEmp.Open "select * from netp where ID = '" & Text1.Text & "'", connEmp, adOpenKeyset, adLockPessimistic, adCmdText
rsEmp.AddNew
